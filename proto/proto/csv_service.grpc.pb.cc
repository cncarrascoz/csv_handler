...
static const char* CsvService_method_names[] = {
  ...
  "/csvservice.CsvService/AppendEntries",
  "/csvservice.CsvService/RequestVote",
};
...
CsvService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_AppendEntries_(CsvService_method_names[12], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RequestVote_(CsvService_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status CsvService::Stub::AppendEntries(::grpc::ClientContext* context, const ::csvservice::AppendEntriesRequest& request, ::csvservice::AppendEntriesResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csvservice::AppendEntriesRequest, ::csvservice::AppendEntriesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_AppendEntries_, context, request, response);
}

void CsvService::Stub::async::AppendEntries(::grpc::ClientContext* context, const ::csvservice::AppendEntriesRequest* request, ::csvservice::AppendEntriesResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csvservice::AppendEntriesRequest, ::csvservice::AppendEntriesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_AppendEntries_, context, request, response, std::move(f));
}

void CsvService::Stub::async::AppendEntries(::grpc::ClientContext* context, const ::csvservice::AppendEntriesRequest* request, ::csvservice::AppendEntriesResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::csvservice::AppendEntriesResponse>* CsvService::Stub::PrepareAsyncAppendEntriesRaw(::grpc::ClientContext* context, const ::csvservice::AppendEntriesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csvservice::AppendEntriesResponse, ::csvservice::AppendEntriesRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_AppendEntries_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csvservice::AppendEntriesResponse>* CsvService::Stub::AsyncAppendEntriesRaw(::grpc::ClientContext* context, const ::csvservice::AppendEntriesRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status CsvService::Stub::RequestVote(::grpc::ClientContext* context, const ::csvservice::RequestVoteRequest& request, ::csvservice::RequestVoteResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::csvservice::RequestVoteRequest, ::csvservice::RequestVoteResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_RequestVote_, context, request, response);
}

void CsvService::Stub::async::RequestVote(::grpc::ClientContext* context, const ::csvservice::RequestVoteRequest* request, ::csvservice::RequestVoteResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::csvservice::RequestVoteRequest, ::csvservice::RequestVoteResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_RequestVote_, context, request, response, std::move(f));
}

void CsvService::Stub::async::RequestVote(::grpc::ClientContext* context, const ::csvservice::RequestVoteRequest* request, ::csvservice::RequestVoteResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::csvservice::RequestVoteResponse>* CsvService::Stub::PrepareAsyncRequestVoteRaw(::grpc::ClientContext* context, const ::csvservice::RequestVoteRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::csvservice::RequestVoteResponse, ::csvservice::RequestVoteRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_RequestVote_, context, request);
}

::grpc::ClientAsyncResponseReader< ::csvservice::RequestVoteResponse>* CsvService::Stub::AsyncRequestVoteRaw(::grpc::ClientContext* context, const ::csvservice::RequestVoteRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
CsvService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      CsvService_method_names[12],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< CsvService::Service, ::csvservice::AppendEntriesRequest, ::csvservice::AppendEntriesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](CsvService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csvservice::AppendEntriesRequest* req,
             ::csvservice::AppendEntriesResponse* resp) {
               return service->AppendEntries(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      CsvService_method_names[13],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< CsvService::Service, ::csvservice::RequestVoteRequest, ::csvservice::RequestVoteResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](CsvService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::csvservice::RequestVoteRequest* req,
             ::csvservice::RequestVoteResponse* resp) {
...
::grpc::Status CsvService::Service::AppendEntries(::grpc::ServerContext* context, const ::csvservice::AppendEntriesRequest* request, ::csvservice::AppendEntriesResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status CsvService::Service::RequestVote(::grpc::ServerContext* context, const ::csvservice::RequestVoteRequest* request, ::csvservice::RequestVoteResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
